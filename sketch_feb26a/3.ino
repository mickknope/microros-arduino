...
//   myservo.setPeriodHertz(50);            // stHIGHandard 50 hz servo
...
//   RCCHECK(rclc_subscription_init(&pwmArray_sub, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, UInt16MultiArray), "/servo/pwm_array", &rmw_qos_profile_default));
//   // create executor
...
//   RCCHECK(rclc_executor_add_subscription(&executor, &pwmArray_sub, &pwmArray_msg, &pwmArray_callback, ON_NEW_DATA));
